...
public class AccountPower {
     ...
     * 账户权限表
     */
    private Integer accountPowerId;
    ...
    /**
     * 账户权限表
     * @return account_power_id 账户权限表
     */
    public Integer getAccountPowerId() {
        return accountPowerId;
    }

    /**
     * 账户权限表
     * @param accountPowerId 账户权限表
     */
    public void setAccountPowerId(Integer accountPowerId) {
        this.accountPowerId = accountPowerId;
    }
    ...
    /**
     * 权限类型，1-管理员，2-用户
     * @return power_type 权限类型，1-管理员，2-用户
     */
    ...
    /**
     * 权限类型，1-管理员，2-用户
     * @param powerType 权限类型，1-管理员，2-用户
     */
