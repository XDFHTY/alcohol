...
public class Order {
    ...
    /**
     * 订单状态，1-未支付，2-已支付，3-已发货，4-已收货，5-已完成，11-未支付（到付），13-已发货，15-已完成
     */
    ...
    /**
     * 订单状态，1-未支付，2-已支付，3-已发货，4-已收货，5-已完成，11-未支付（到付），13-已发货，15-已完成
     * @return order_status 订单状态，1-未支付，2-已支付，3-已发货，4-已收货，5-已完成，11-未支付（到付），13-已发货，15-已完成
     */
    ...
    /**
     * 订单状态，1-未支付，2-已支付，3-已发货，4-已收货，5-已完成，11-未支付（到付），13-已发货，15-已完成
     * @param orderStatus 订单状态，1-未支付，2-已支付，3-已发货，4-已收货，5-已完成，11-未支付（到付），13-已发货，15-已完成
     */
    ...
    /**
     * 订单状态，0-已删除，1-未删除
     * @return del_state 订单状态，0-已删除，1-未删除
     */
    ...
    /**
     * 订单状态，0-已删除，1-未删除
     * @param delState 订单状态，0-已删除，1-未删除
     */
